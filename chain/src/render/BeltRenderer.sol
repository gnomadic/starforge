    ...
    function generateImages(
        ...
        return
            string.concat(
                ...
                '<circle id="water" cx="256" cy="256" r="100" fill="hsl(120, 47%, 58%)" opacity="1" />',
                '<circle id="ground" cx="256" cy="256" r="100" stroke="black" fill="hsl(180, 47%, 58%)" stroke-width="12" filter="url(#planet)" mask="url(#planetmask)" />',
